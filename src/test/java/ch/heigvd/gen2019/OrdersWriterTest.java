...
public class OrdersWriterTest {
    ...
    @Test
    public void NoOrder() {
        assertEquals("{\"orders\": []}", new Orders().getOrders());
    }

    @Test
    public void OneOrder() {
        String order111 = "{\"id\": 111, \"products\": []}";
        assertEquals("{\"orders\": [" + order111 + "]}", orders.getOrders());
    }
    ...
    public void TwoOrders() {
        ...
        assertEquals("{\"orders\": [" + order111Json + ", " + order222Json + "]}", orders.getOrders());
    }
    ...
    public void OneOrderWithOneProduct() {
        ...
        assertEquals("{\"orders\": [" + order111Json + "]}", orders.getOrders());
    }

    @Test
    public void OneOrderWithOneProductNoSize() {
        order111.AddProduct(new Product("Pot", new Red(), null, 16.50, "SGD"));
